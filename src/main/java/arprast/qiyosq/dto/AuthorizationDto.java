...
public class AuthorizationDto extends Dto {
    ...
    public AuthorizationDto(Date createTime, Date modifyTime, Long id, String menuName, Long parentId, boolean isUpdate, boolean isDelete, boolean isInsert, boolean isRead) {
        this.id = id;
        this.menuName = menuName;
        this.parentId = parentId;
        this.isUpdate = isUpdate;
